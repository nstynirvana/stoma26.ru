...
if(\Bitrix\Main\Loader::includeSharewareModule("krayt.okshop") == \Bitrix\Main\Loader::MODULE_DEMO_EXPIRED ||
    \Bitrix\Main\Loader::includeSharewareModule("krayt.okshop") ==  \Bitrix\Main\Loader::MODULE_NOT_FOUND
)
{
    $APPLICATION->IncludeFile(SITE_TEMPLATE_PATH.'/alert_install.php');
    die();
