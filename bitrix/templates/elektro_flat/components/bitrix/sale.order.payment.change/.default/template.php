		...
		<div class="sale-order-payment-change-pp">
			<div class="sale-order-payment-change-inner-row">
				<div class="sale-order-payment-change-inner-row-body">
					<div class="sale-order-payment-change-payment">
						<div class="sale-order-payment-change-payment-title">
							...
							if ($arResult['PAYMENT']['PAID'] === 'Y') {
								...
								<div class="alertMsg good">
									...
									<span class="text"><?=Loc::getMessage('SOPC_TPL_PAID')?></span>
								</div>
								<?
								...
								<div class="alertMsg info">
									...
									<span class="text"><?=Loc::getMessage('SOPC_TPL_RESTRICTED_PAID')?></span>
								</div>
								<?
							} else {
								?>
								<div class="alertMsg bad">
									<i class="fa fa-exclamation-triangle"></i>
									<span class="text"><?=Loc::getMessage('SOPC_TPL_NOTPAID')?></span>
								</div>
								<?
							}
							?>
			...
			<div class="sale-order-payment-change-pp-list">
				...
				foreach ($arResult['PAYSYSTEMS_LIST'] as $key => $paySystem) {
					...
					<div class="sale-order-payment-change-pp-company">
						<div class="sale-order-payment-change-pp-company-graf">
							<div class="sale-order-payment-change-pp-company-graf-container">
								...
								?>
								<div class="sale-order-payment-change-pp-company-image-container">
								<input type="hidden"
