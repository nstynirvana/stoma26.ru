...
if($request->isPost() && check_bitrix_sessid()) {
	...
	switch($action) {
		...
		case "props":		
            ...
            <? echo"<pre>"; print_r($arParams["OFFERS_FIELD_CODE"]); echo"</pre>";?>
			...
			<?$APPLICATION->IncludeComponent("bitrix:catalog.element", "quick_view",
				array(
					...
					"LINK_ELEMENTS_URL" => $arParams["LINK_ELEMENTS_URL"],
					"OFFERS_CART_PROPERTIES" => $arParams["OFFERS_CART_PROPERTIES"],
					"OFFERS_FIELD_CODE" =>$arParams["LIST_OFFERS_FIELD_CODE"], //array(),
					"OFFERS_PROPERTY_CODE" => $arParams["OFFERS_PROPERTY_CODE"],
					"OFFERS_SORT_FIELD" => $arParams["OFFERS_SORT_FIELD_PP"],
					"OFFERS_SORT_ORDER" => $arParams["OFFERS_SORT_ORDER"],
					"OFFERS_SORT_FIELD2" => $arParams["OFFERS_SORT_FIELD2"],
					...
					"SECTION_URL" => "",
					"DETAIL_URL" => "",
					"MAIN_BLOCK_PROPERTY_CODE"=>$arParams["PROPERTY_CODE"],
