...
foreach($arResult["ITEMS"] as $key => $arItem) {
	...
	if(!empty($arItem["DATE_CREATE"]))
		$arResult["ITEMS"][$key]["DISPLAY_DATE_CREATE"] = CIBlockFormatProperties::DateFormat($arParams["ACTIVE_DATE_FORMAT"], MakeTimeStamp($arItem["DATE_CREATE"], CSite::GetDateFormat()));
