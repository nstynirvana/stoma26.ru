	...
	<?$frame = $this->createFrame("mfeedback")->begin();
		...
		<form action="<?=$APPLICATION->GetCurPage()?>" method="POST">
			...
			*/?>
			...
			<div class="row">
				<div class="span1">
					<?=GetMessage("MFT_DATE")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("MESSAGE", $arParams["REQUIRED_FIELDS"])):?><span class="mf-req">*</span><?endif?>
				</div>
				<div class="span2">
					<input type="date" name="date_input"><?=$arResult["MESSAGE"]?></textarea>
				</div>
				<div class="clr"></div>
			</div>
