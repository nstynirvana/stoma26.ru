...
header('Content-Type: text/html; charset='.SITE_CHARSET);
 ...
 {
    $_REQUEST["UF_MESS_ADV"] = iconv('UTF-8','windows-1251', $_REQUEST["UF_MESS_ADV"]);
    $_REQUEST["UF_MESS_COMM"] = iconv('UTF-8','windows-1251', $_REQUEST["UF_MESS_COMM"]);
    $_REQUEST["UF_MESS_LIM"] = iconv('UTF-8','windows-1251', $_REQUEST["UF_MESS_LIM"]);
    $_REQUEST["UF_NAME"] = iconv('UTF-8','windows-1251', $_REQUEST["UF_NAME"]);
    $_REQUEST["UF_TERM_OF_USE"] = iconv('UTF-8','windows-1251', $_REQUEST["UF_TERM_OF_USE"]); 
 }
