...
$APPLICATION->SetPageProperty("description", "В интернет-магазине Stoma26.ru вы можете купить все необходимое для реабилитации стомированных больных. Доступные цены. Онлайн заказ. Доставка по России.");
$APPLICATION->SetPageProperty("title", "Каталог товаров для стомы интернет- магазина Stoma26");
